...
export default async function DashboardPage() {
  ...
  const [docCount, pendingCount, readyCount, totalRequests] = await Promise.all(
    [
  ...
  const userName = session?.user?.name || "Citoyen";
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">
          Bienvenue sur votre espace CitizenPass
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-3">
            <Link href="/dashboard/request-new" className="block">
            ...
            {docCount === 0 ? (
              <div className="text-center py-8 text-gray-400">
                ...
                <p className="text-sm mt-1">
                  Faites une demande pour commencer.
                </p>
              </div>
            ) : (
